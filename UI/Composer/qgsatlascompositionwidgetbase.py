...
# Form implementation generated from reading ui file 'qgsatlascompositionwidgetbase.ui'
#
...
class Ui_QgsAtlasCompositionWidgetBase(object):
    def setupUi(self, QgsAtlasCompositionWidgetBase):
        QgsAtlasCompositionWidgetBase.setObjectName(_fromUtf8("QgsAtlasCompositionWidgetBase"))
        ...
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mUseAtlasCheckBox, self.mConfigurationGroup)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mConfigurationGroup, self.mAtlasCoverageLayerComboBox)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasCoverageLayerComboBox, self.mAtlasHideCoverageCheckBox)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasHideCoverageCheckBox, self.mAtlasFeatureFilterCheckBox)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasFeatureFilterCheckBox, self.mAtlasFeatureFilterEdit)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasFeatureFilterEdit, self.mAtlasFeatureFilterButton)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasFeatureFilterButton, self.mAtlasSortFeatureCheckBox)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasSortFeatureCheckBox, self.mAtlasSortFeatureKeyComboBox)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasSortFeatureKeyComboBox, self.mAtlasSortFeatureDirectionButton)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasSortFeatureDirectionButton, self.mOutputGroup)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mOutputGroup, self.mAtlasFilenamePatternEdit)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasFilenamePatternEdit, self.mAtlasFilenameExpressionButton)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasFilenameExpressionButton, self.mAtlasSingleFileCheckBox)
        QgsAtlasCompositionWidgetBase.setTabOrder(self.mAtlasSingleFileCheckBox, self.scrollArea)

    def retranslateUi(self, QgsAtlasCompositionWidgetBase):
        QgsAtlasCompositionWidgetBase.setWindowTitle(_translate("QgsAtlasCompositionWidgetBase", "Atlas Generation", None))
        self.mUseAtlasCheckBox.setText(_translate("QgsAtlasCompositionWidgetBase", "Generate an atlas", None))
        self.mConfigurationGroup.setTitle(_translate("QgsAtlasCompositionWidgetBase", "Configuration", None))
        self.mAtlasSortFeatureDirectionButton.setToolTip(_translate("QgsAtlasCompositionWidgetBase", "Sort direction", None))
        self.mAtlasSortFeatureDirectionButton.setText(_translate("QgsAtlasCompositionWidgetBase", "...", None))
        self.mAtlasFeatureFilterCheckBox.setText(_translate("QgsAtlasCompositionWidgetBase", "Filter with", None))
        self.mAtlasFeatureFilterButton.setText(_translate("QgsAtlasCompositionWidgetBase", "...", None))
        self.mAtlasHideCoverageCheckBox.setText(_translate("QgsAtlasCompositionWidgetBase", "Hidden coverage layer", None))
        self.mHorizontalAlignementLabel.setText(_translate("QgsAtlasCompositionWidgetBase", "Coverage layer ", None))
        self.label.setText(_translate("QgsAtlasCompositionWidgetBase", "Page name", None))
        self.mAtlasSortFeatureCheckBox.setText(_translate("QgsAtlasCompositionWidgetBase", "Sort by", None))
        self.mOutputGroup.setTitle(_translate("QgsAtlasCompositionWidgetBase", "Output", None))
        self.label_4.setText(_translate("QgsAtlasCompositionWidgetBase", "Output filename expression", None))
        self.mAtlasFilenameExpressionButton.setText(_translate("QgsAtlasCompositionWidgetBase", "...", None))
        self.mAtlasSingleFileCheckBox.setText(_translate("QgsAtlasCompositionWidgetBase", "Single file export when possible", None))
