...
class Ui_QgsCompositionWidgetBase(object):
    def setupUi(self, QgsCompositionWidgetBase):
        QgsCompositionWidgetBase.setObjectName(_fromUtf8("QgsCompositionWidgetBase"))
        ...
        QgsCompositionWidgetBase.setTabOrder(self.groupBox, self.mPaperSizeComboBox)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperSizeComboBox, self.mPaperSizeDDBtn)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperSizeDDBtn, self.mPaperWidthDoubleSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperWidthDoubleSpinBox, self.mPaperWidthDDBtn)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperWidthDDBtn, self.mPaperHeightDoubleSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperHeightDoubleSpinBox, self.mPaperHeightDDBtn)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperHeightDDBtn, self.mPaperUnitsComboBox)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperUnitsComboBox, self.mPaperOrientationComboBox)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperOrientationComboBox, self.mPaperOrientationDDBtn)
        QgsCompositionWidgetBase.setTabOrder(self.mPaperOrientationDDBtn, self.mTopMarginSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mTopMarginSpinBox, self.mLeftMarginSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mLeftMarginSpinBox, self.mRightMarginSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mRightMarginSpinBox, self.mBottomMarginSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mBottomMarginSpinBox, self.mResizePageButton)
        QgsCompositionWidgetBase.setTabOrder(self.mResizePageButton, self.mNumPagesSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mNumPagesSpinBox, self.mNumPagesDDBtn)
        QgsCompositionWidgetBase.setTabOrder(self.mNumPagesDDBtn, self.mPageStyleButton)
        QgsCompositionWidgetBase.setTabOrder(self.mPageStyleButton, self.mResolutionSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mResolutionSpinBox, self.mPrintAsRasterCheckBox)
        QgsCompositionWidgetBase.setTabOrder(self.mPrintAsRasterCheckBox, self.mGenerateWorldFileCheckBox)
        QgsCompositionWidgetBase.setTabOrder(self.mGenerateWorldFileCheckBox, self.mWorldFileMapComboBox)
        QgsCompositionWidgetBase.setTabOrder(self.mWorldFileMapComboBox, self.mSnapToGridGroupCheckBox)
        QgsCompositionWidgetBase.setTabOrder(self.mSnapToGridGroupCheckBox, self.mGridResolutionSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mGridResolutionSpinBox, self.mOffsetXSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mOffsetXSpinBox, self.mOffsetYSpinBox)
        QgsCompositionWidgetBase.setTabOrder(self.mOffsetYSpinBox, self.mSnapToleranceSpinBox)

    def retranslateUi(self, QgsCompositionWidgetBase):
        QgsCompositionWidgetBase.setWindowTitle(_translate("QgsCompositionWidgetBase", "Composition", None))
